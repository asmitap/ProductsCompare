                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="compare_first" name="p1" id="select">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="compare_second" name="p2" id="select">
                                    <option value="">Select Phone</option>
                                    @foreach($datas as $data)
                                    <option value="{{$data->id}}" id="{{$data->id}}">{{$data->product_name}}</option>
                                    @endforeach
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="compare_third" name="p3" id="select">
                                    <option value="">Select Phone</option>
                                    @foreach($datas as $data)
                                    <option value="{{$data->id}}" id="{{$data->id}}">{{$data->product_name}}</option>
                                    @endforeach
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="compare_fourth" name="p4" id="select">
                                    <option value="">Select Phone</option>
                                    @foreach($datas as $data)
                                    <option value="{{$data->id}}" id="{{$data->id}}">{{$data->product_name}}</option>
                                    @endforeach
